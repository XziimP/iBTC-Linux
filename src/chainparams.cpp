...
// Copyright (c) 2020 The iBitcoin Core developers
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2 * 60 * 60; // 2 hour
        ...
        // getblockchaininfo
        consensus.nMinimumChainWork = uint256S("0001");
        ...
        checkpointData = {
            {
                { 1, uint256S("0x0000000003b720781d412f81b8db4e98053959179860eb570b1593a31485d87d")}, // iBTC Fork
                { 131, uint256S("0x0000000000001ee6303bb7976e356b3edef72dad995b7b002b7d2d95a9a1de46")}
